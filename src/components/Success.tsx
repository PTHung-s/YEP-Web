      ...
      {polling ? (
        ...
        <>
          ...
          <div className="bg-surface border-4 border-primary p-6 md:p-8 text-left mb-10">
            ...
            <div className="border-2 border-dashed border-primary p-4 flex items-center gap-3 bg-primary-container/50">
              ...
              <div className="text-left">
                ...
                <span className="font-display text-lg md:text-xl font-black tracking-tighter">{ticketId || 'PROCESSING...'}</span>
              </div>
            </div>
          </div>
            ...
            <div className="bg-primary-container border-4 border-primary p-6 text-left flex items-start gap-4">
              ...
              <div>
                ...
                <p className="font-body text-sm font-medium leading-relaxed">
                  Vé điện tử đã được gửi về <span className="font-display font-bold">{state.email}</span>. Vui lòng kiểm tra hộp thư đến (và Spam nếu không thấy).
                </p>
              </div>
            </div>
            <div className="bg-primary-container border-4 border-primary p-6 text-left flex items-start gap-4">
