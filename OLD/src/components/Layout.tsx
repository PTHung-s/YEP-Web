      ...
      <footer className="w-full py-12 px-6 md:px-12 flex flex-col gap-8 md:flex-row justify-between items-start bg-surface border-t border-primary mt-auto">
        ...
        <div className="flex flex-wrap gap-x-12 gap-y-8">
          ...
          <nav className="flex flex-col gap-4">
            ...
            <a href="#" className="font-display text-xs font-bold uppercase tracking-widest text-primary hover:text-secondary transition-colors">INSTAGRAM</a>
            <a href="#" className="font-display text-xs font-bold uppercase tracking-widest text-primary hover:text-secondary transition-colors">FACEBOOK</a>
            <a href="#" className="font-display text-xs font-bold uppercase tracking-widest text-primary hover:text-secondary transition-colors">TWITTER</a>
          </nav>
        </div>
      </footer>
